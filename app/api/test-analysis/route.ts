...
export async function POST(request: Request) {
  ...
  if (body.action === "upsert_question") {
    ...
    const saved = await upsertQuestionLog({
      ...
      questionType: question.questionType ? String(question.questionType) : null,
      questionSummary: String(question.questionSummary ?? ""),
      selectedAnswer: question.selectedAnswer ? String(question.selectedAnswer) : null,
      ...
      valueAddedPoints: question.valueAddedPoints ? String(question.valueAddedPoints) : null,
      ...
      marksAwarded: question.marksAwarded === null || question.marksAwarded === undefined ? null : Number(question.marksAwarded),
      maxMarks: question.maxMarks === null || question.maxMarks === undefined ? null : Number(question.maxMarks),
      wordLimit: question.wordLimit === null || question.wordLimit === undefined ? null : Number(question.wordLimit),
      wordCount: question.wordCount === null || question.wordCount === undefined ? null : Number(question.wordCount),
      structureScore: question.structureScore === null || question.structureScore === undefined ? null : Number(question.structureScore),
      contentScore: question.contentScore === null || question.contentScore === undefined ? null : Number(question.contentScore),
      presentationScore:
        question.presentationScore === null || question.presentationScore === undefined
          ? null
          : Number(question.presentationScore),
